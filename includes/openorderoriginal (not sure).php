<!-- row start -->
                      ...
                      <div class="panel panel-default panel-market-list-small">
                        ...
                        <form action="#" class="middle-forms" name="tradebuy" id="buyorderform" onsubmit="event.returnValue = false; return false;" method="post" accept-charset="utf-8">
                          <div style="display:none;"><input type="hidden" name="_method" value="POST"/>
                            ...
                            <ol>
                              ...
                              <li class='even'><div class="input text"><label for="TradeBuyPrice" class="field-title">Price Per <?php echo $coin1;?></label>
                                <input id="buyprice" name="price" value="0.00000000" class="txtbox-short form-control" style="float:left;" type="text" onKeyUP="updateFields(this);"/>
                              </div>&nbsp;&nbsp;
                              ...
                              <?php
                              $fee = BaseDonnee::execQuery($bdd, "SELECT * FROM Markets WHERE Pair = '$pair'")[0]["Fee"];
                          ...
                          <p class="submit-holder">
                            ...
                            <small>	
                              <span onclick="$('#buyamount').val($(this).text());$('#buyamount').trigger('change');" style="cursor:pointer; font-weight: bold; color: #428bca;" class="genbalance_3"><?php echo  $balance2;?></span> <?php echo $coin2;?> Available&nbsp;&nbsp;&nbsp
                            </small>
                    ...
                    <div class="col-xs-6">
                      <div class="panel panel-default panel-market-list-small">
                          ...
                          <fieldset>
                           <ol>
                            ...
                            <li class='even'><div class="input text"><label for="TradeSellPrice" class="field-title">Price Per <?php echo $coin1;?></label>
                              <input id="sellprice" name="price" value="0.00000000" class="txtbox-short form-control" style="float:left;" type="text" onKeyUP="updateFields(this);"/></div>&nbsp;&nbsp;
                        ...
                        <p class="submit-holder">
                          ...
                          <small>
                           <span onclick="$('#sellamount').val($(this).text());$('#sellamount').trigger('change');" style="cursor:pointer; font-weight: bold; color: #428bca;" class="genbalance_8"><?php echo $availableBalance1;?></span> <?php echo $coin1;?> Available&nbsp;&nbsp;&nbsp;
                         </small>
              ...
              <div class="panel panel-default panel-trade-list">
                ...
                <div class="tablewrap"  id="market-wrap" style="height:100px; overflow:auto; color:#80BFFF;">
